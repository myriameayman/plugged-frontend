	...
	$(document).ready(function() {
		...
		// alert("window height "+ footer.top);
		// $('.leftmrgn').css('height',footer.top+'px');  
	...
	if(window.innerWidth < 500){
		...
		$('.banner_head').css('font-size','40px');
	}
	else{
		if(window.innerWidth < 865){
			...
			$('.banner_head').css('font-size','55px'); 
			...
			$('.banner_head').css('font-size','60px'); 
	...
	window.onresize = function() {
		$('.leftmrgn').css('height',screen.height +'px');  
		if(window.innerWidth < 500){
			$('.col').css('width', 85 + '%'); 
			$('.container-article').css('width', 85 + '%'); 
			$('.container-index').css('width', 95 + '%'); 
			$('.banner_head').css('font-size','50px');
			...
			if(window.innerWidth < 865){
				...
				$('.container-article').css('width', 30 + '%'); 
				$('.container-index').css('width', 70 + '%'); 
				$('.banner_head').css('font-size','55 px');
